...
p1 = Product.create([
										...
										price:rand(1..5),
										image:open(products[0][:image_path].first(2))
										])

p2 = Product.create([
										title:products[1][:title],
										description:products[1][:description],
										body:products[1][:body],
										category:products[1][:category],
										quantity:rand(3..9) * 100 ,
										price:rand(1..5),
										image:open(products[1][:image_path].first(2)),
										])

p3 = Product.create([
										title:products[2][:title],
										description:products[2][:description],
										body:products[2][:body],
										category:products[2][:category],
										quantity:rand(3..9) * 100 ,
										price:rand(1..5),
										image:open(products[2][:image_path].first(2)),
										])

p4 = Product.create([
										title:products[3][:title],
										description:products[3][:description],
										body:products[3][:body],
										category:products[3][:category],
										quantity:rand(3..9) * 100 ,
										price:rand(1..5),
										image:open(products[3][:image_path].first(2)),
										])
