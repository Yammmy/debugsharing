...
products =[
					...
					description: "此经验由@YY老师提供，单张图片对购物网站来说已经没法满足要求了，此教程可以快速帮你实现多张图片上传功能。具体请手机扫描下方二维码跳转logdown链接。",
					body: "如果觉得这篇教程有用，欢迎扫下方二维码打赏。",
					category: "rails",
				 },

					{
					title:"部署到Heroku,图片不显示？",
          description: "此经验由@panxiubin助教提供。初次使用aws服务的同学，在将专案部署到heroku之后，常常会遇到图片无法正常显示的问题，此经验可以有效的解决这个问题，有图有真相，灰常容易理解。具体请手机扫描下方二维码跳转logdown链接。",
					body: "如果觉得这篇教程有用，欢迎扫下方二维码打赏。",
					category: "heroku",
				 },
					...
					{
					title:"页面布局的高频小套路",
          description: "此经验由@raimonfuns同学提供。初次接触编程的同学，最大的痛点可能就是前端了，一个好看的网站页面可以让网站焕发出无限的魅力，此经验告诉你前端的高频小套路。具体请手机扫描下方二维码跳转全栈营论坛链接。",
					body: "如果觉得这篇教程有用，欢迎扫下方二维码打赏。",
					category: "frontend",
				},
					...
					{
					title:"如何筛选出我已投递的工作？",
          description: "此经验由@megychen同学提供。job-listing中，如果我们想让用户筛选出已经投递的工作，该怎么办呢？其实，此前rails101的教程中其实已经给出了线索，具体如何操作呢？快来看@megychen的解答。具体请手机扫描下方二维码跳转全栈营论坛链接。",
					body: "如果觉得这篇教程有用，欢迎扫下方二维码打赏。",
					category: "backend",
				},
          ...
          description: "此经验由@yammy同学提供。作为我们常用的三兄弟数据命令，一般来说我们需要用三次命令来完成数据的重整，此经验可以把这三个命令合并，从此本地整理数据，只需要一个命令即可快速解决问题。具体请手机扫描下方二维码跳转logdown链接。",
					body: "如果觉得这篇教程有用，欢迎扫下方二维码打赏。",
					category: "rails",
				},
...
photos = [
				  	...
				  	"#{Rails.root}/app/assets/images/railsma2.png",
            ...
            "#{Rails.root}/app/assets/images/frontendma1.png",
						"#{Rails.root}/app/assets/images/backend1.jpg",
					  "#{Rails.root}/app/assets/images/backendma1.png",
						"#{Rails.root}/app/assets/images/rails1.jpg",
				  	"#{Rails.root}/app/assets/images/railsma1.png"
				]
